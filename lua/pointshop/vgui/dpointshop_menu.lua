...
function PS.AddSlider(panel, text, value, min, max, snap, callback)
    ...
    button:SetWide(32)
    button:SetIcon("pointshop/derma/reset.png", 20, 20)
...
function PANEL:Init()
    ...
    self.btnClose.Mat = Material("pointshop/derma/close.png", "noclamp smooth")
    ...
    self.Settings:SetIcon("pointshop/derma/settings.png", self.BarHeight, self.BarHeight)
    ...
    self.SideBarToggle.Mat = Material("pointshop/derma/menu.png", "noclamp smooth")
    ...
    self.Buy:SetIcon("pointshop/derma/shopping_cart.png", 18, 18)
    self.Buy:SetHoverText(nil)
    self.Buy:SetHoverIcon("pointshop/derma/shopping_cart.png", 18, 18)
    ...
    self.Buy.DoClick = function(this)
        ...
        if ply:PS_HasItem(this.Item.ID) then
            if this.PressedOnce then
                ...
                this:SetHoverIcon("pointshop/derma/warning.png", 18, 18)
    ...
    self.Buy.SetItem = function(this, item)
        ...
        if ply:PS_HasItem(item.ID) then
            this:SetText("Sell")
            this:SetHoverIcon("pointshop/derma/sell.png", 18, 18)
    ...
    self.CustomizePanel.SetupTopBar = function(this, item)
        ...
        button:SetIcon("pointshop/derma/arrow_back.png", 20, 20)
        button.Item = item
    ...
    self.ModelHeight.Slider.Knob.Mat = Material("pointshop/derma/unfold_more.png", "noclamp smooth")
    ...
    self.ModelReset:SetIcon("pointshop/derma/reset.png", 20, 20)
    ...
    self.PlayerInfo.Mat = Material("pointshop/derma/attach_money.png", "noclamp smooth")
...
function PANEL:PopulateCategories()
    ...
    self.AdminButton:SetIcon("pointshop/derma/admin_panel_settings.png")

    self.PointsButton = self.Left:Add("PS_SidebarButton")
    self.PointsButton:Dock(BOTTOM)
    self.PointsButton:SetText("Give Points")
    self.PointsButton:SetIcon("pointshop/derma/payments.png")
...
function PANEL:MakeSubcategories(button, category)
    ...
    button.Panel:Dock(FILL)
    button.Panel:DockMargin(12, 12, 0, 12)
    button.Panel.pnlCanvas:DockPadding(0, 0, 12, 0)
    button.Panel:Hide()
